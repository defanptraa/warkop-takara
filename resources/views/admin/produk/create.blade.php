...
<div class="max-w-2xl mx-auto py-12 px-6">
    ...
    <nav class="text-sm mb-6" aria-label="Breadcrumb">
        <ol class="flex text-gray-500 space-x-2">
            ...
            <li>/</li>
            <li class="text-gray-800 font-semibold">Tambah Produk</li>
        </ol>
    </nav>
    ...
    <div class="bg-white shadow-xl rounded-2xl p-8 ring-1 ring-gray-200 space-y-6 animate-fade-in-down">
        <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @include('admin.produk._form', ['submit' => 'Simpan'])
            ...
            <div class="flex justify-end">
                ...
                <button type="submit"
                        class="inline-flex items-center gap-2 bg-primary hover:bg-highlight text-white px-6 py-2 text-sm rounded-xl font-semibold shadow-md transition">
